...
impl SumUpClient {
    ...
    #[deprecated(since = "0.2.0", note = "The /me/readers endpoint does not exist. Use list_merchant_readers instead.")]
    ...
    #[deprecated(since = "0.2.0", note = "The /me/readers endpoint does not exist. Use create_merchant_reader instead.")]
    ...
    #[deprecated(since = "0.2.0", note = "The /me/readers/{reader_id} endpoint does not exist. Use retrieve_merchant_reader instead.")]
    ...
    #[deprecated(since = "0.2.0", note = "The /me/readers/{reader_id} endpoint does not exist. Use update_merchant_reader instead.")]
    ...
    #[deprecated(since = "0.2.0", note = "The /me/readers/{reader_id} endpoint does not exist. Use delete_merchant_reader instead.")]
    ...
    #[deprecated(since = "0.2.0", note = "The /me/readers/{reader_id}/checkout endpoint does not exist. Use create_merchant_reader_checkout instead.")]
    ...
    #[deprecated(since = "0.2.0", note = "The /me/readers/{reader_id}/checkout/{checkout_id} endpoint does not exist. Use terminate_merchant_reader_checkout instead.")]
